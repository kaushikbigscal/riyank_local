        ...
        for picking in self:
            ...
            for move in picking.move_ids:
                ...
                for lot in serials:
                    ...
                    # 🔹 Determine order_line & unit_status
                    if sale_order:
                    ...
                    # 🔹 Extended warranty logic (same as button_validate)
...
class LotLabelLayout(models.TransientModel):
    ...
    def process(self):
        """Extend process to add CustomerProductMapping creation before calling original print logic"""
        self.ensure_one()
        ...
        return super(LotLabelLayout, self).process()
