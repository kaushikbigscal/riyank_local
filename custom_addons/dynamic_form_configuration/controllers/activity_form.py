...
class ActivityFormController(http.Controller):

    @http.route('/web/activity_form', type='json', auth='user')
    def get_activity_form(self):
        return self._get_activity_mobile_form_view('mail.activity', 'mail.mail_activity_view_form')

    def _get_activity_mobile_form_view(self, model_name, view_xml_id):
        try:
            ...
            if form_elements:
                ...
                if sheet_elements:
                    sheet_element = sheet_elements[0]
