...
class MailThreadFCM(models.AbstractModel):
    ...
    def _notify_thread(self, message, msg_vals=False, **kwargs):
        ...
        try:
            ...
            # Exclude the message sender's user_id
            author_user_id = message.author_id.user_ids[:1].id
            user_ids = [uid for uid in user_ids if uid != author_user_id]
            ...
            if user_ids:
                ...
                _logger.info("No user_ids to notify after filtering")

        except Exception as e:
            _logger.error(f"Error sending FCM notification in mail_thread: {e}")

        _logger.info("Returning from _notify_thread")
