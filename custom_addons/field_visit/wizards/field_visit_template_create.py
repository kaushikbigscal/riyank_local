...
class FieldVisitTemplateCreate(models.TransientModel):
    _name = "field.visit.template.create"
    _description = "field visit template create"

    def _default_date_to(self):
        template = self.env["field.visit.template"].browse(
