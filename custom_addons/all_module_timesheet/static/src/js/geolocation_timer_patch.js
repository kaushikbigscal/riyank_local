...
function sendLocationCommand(command, sync = false) {
    if (window.ReactNativeWebView) {
        ...
        console.log("?? Not inside React Native WebView, skipping...");
    }
}
...
//        ];
        ...
        const GEO_ACTIONS = {
            ...
            //field visit
            "button_start_work": { cmd: "STOP_LOCATION_SERVICE", sync: true },
            "action_end_work": { cmd: "START_LOCATION_SERVICE", sync: false },
