    ...
    def action_open_map_view(self):
        ...
        if self.start_latitude and self.start_longitude and self.end_latitude and self.end_longitude:
            url = (
                ...
                f"&origin={self.start_latitude},{self.start_longitude}"
                f"&destination={self.end_latitude},{self.end_longitude}"
            )
            return {
            ...
            raise UserError("Start or end location coordinates are missing.")
