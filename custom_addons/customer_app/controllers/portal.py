...
class PortalHomePage(http.Controller):
    ...
    def list_products(self, contract_id=None, sortby='name', filterby='all', groupby='', search='', **kwargs):
        ...
        for mapping in mappings:
            ...
            products_data.append({
                ...
                'status': dict(mapping._fields['status'].selection).get(mapping.status, 'N/A'),
    ...
    @http.route('/get/reason/by/complaint', type='http', auth='public', website=True, csrf=False)
    ...
    @http.route('/ticket/submit', type='http', auth='public', website=True, csrf=True, methods=['POST'])
...
class TicketPaymentPortal(payment_portal.PaymentPortal):
    ...
    @http.route(['/my/quotations/<int:order_id>'], type='http', auth="public", website=True)
