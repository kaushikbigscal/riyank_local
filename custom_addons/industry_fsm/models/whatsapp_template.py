...
class TemplateWhatsapp(models.Model):
    ...
    message = fields.Html(string="Message", help="Set dynamic message using legends")
    ...
    legend_info = fields.Html(
        ...
        default=lambda self: _(
            """
            <div style="width: 400px; height: 145px; max-width: 900px; box-sizing: border-box;">
                <ul style="list-style-type: disc; margin: 0; padding-left: 20px;">
                    <li><span style="font-weight: bold;">{{task_name}}: Name of the service call.</li></span>
                    <li><span style="font-weight: bold;">{{stage_name}}: Current stage of the service call.</li></span>
                    <li><span style="font-weight: bold;">{{ticket_number}}: Ticket number of the service call.</li></span>
                    <li><span style="font-weight: bold;">{{assignee_name}}: Assignee of the service call.</li></span>
                    <li><span style="font-weight: bold;">{{assignee_number}}: Assignee Mobile Number.</li></span>
                    <li><span style="font-weight: bold;">{{customer_name}}: Customer of the service call.</li></span>
                    <li><span style="font-weight: bold;">{{planned_date}}: Planned date of the service call.</li></span>
                </ul>
            </div>
            """
        )
