...
class ResConfigSettings(models.TransientModel):
    ...
    product_code=fields.Selection([('qr_code','QR Code'),
                                          ('barcode','Barcode'),
                                          ('none','None')],string='Product Code',default='none')
    ...
    def set_values(self):
        ...
        config.set_param('industry_fsm.product_code', self.product_code)
    ...
    def get_values(self):
        ...
        res.update({
            ...
            'product_code': config.get_param('industry_fsm.product_code', 'none'),
