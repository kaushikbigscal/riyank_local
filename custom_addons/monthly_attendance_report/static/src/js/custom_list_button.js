...
export class CustomListController extends Component {
    ...
    async _loadReportData() {
        ...
        if (month) {
            ...
            console.log('Year:', year, 'Month Number:', monthNum);
        ...
        if (departmentIds.length > 0) {
            ...
            console.log('Domain after adding departments:', domain);
        }

        if (employeeIds.length > 0) {
            domain.push(['employee_id', 'in', employeeIds]);
            console.log('Domain after adding employees:', domain);
        }

        try {
            console.log('Calling ORM searchRead with domain:', domain);
            ...
            console.log('Report lines fetched:', this.reportLines);
        } catch (error) {
        ...
        console.log('--- _loadReportData END ---');
    }

    _renderReportData() {
        console.log('--- _renderReportData START ---');

        const container = this.treeViewContainerRef.el;
        console.log('Tree view container:', container);

        const reportContainer = this.reportDataContainerRef.el;
        console.log('Report data container:', reportContainer);
        ...
        if (this.reportLines.length === 0) {
            ...
            console.log('No report lines to render.');
            return;
        }
        ...
        console.log('--- _renderReportData END ---');
    }

    async onViewClicked() {
        console.log('--- onViewClicked START ---');
        ...
        if (!month) {
            ...
            console.log('Month not selected, exiting onViewClicked.');
            return;
        }

        try {
            console.log('Calling ORM to generate report lines...');
